...
"""
最终：（已去停用词）
modelfilename = "./model/word2vec20200711(20).model"  # model = word2vec.Word2Vec(sentences, window=20, negative=2, min_count=2)；
验证：
白盒：modelfilename = "./model/word2vec20200711(20).model"  # model = word2vec.Word2Vec(sentences, window=20, negative=2, min_count=2)；
黑盒：modelfilename = "./model/word2vec20200711(3).model"  # model = word2vec.Word2Vec(sentences, window=5, min_count=2)；  
"""
...
def train(segmentfilename, modelfilename):
    ...
    # 训练语料，COBW
    # model = word2vec.Word2Vec(sentences, window=5, min_count=2)  # modelfilename = "./model/word2vec(5).model"
    model = word2vec.Word2Vec(sentences, window=20, negative=2, min_count=2)  # modelfilename = "./model/word2vec(20).model"
...
if __name__ == '__main__':
    # 分词训练文档，模型保存路径
    segmentfilename = "./data/财经类/trainset_segment.txt"

    # modelfilename = "./model/财经类/word2vec(5).model"  # model = word2vec.Word2Vec(sentences, window=5, min_count=2)
    # modelfilename = "./model/财经类/word2vec(20).model"  # model = word2vec.Word2Vec(sentences, window=20, negative=2, min_count=2)
    modelfilename = "./model/财经类/word2vec(20.1).model"  # model = word2vec.Word2Vec(sentences, window=20, negative=2, min_count=2)

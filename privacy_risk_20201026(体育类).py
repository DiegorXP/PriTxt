...
if __name__ == '__main__':
    # 分词训练文档，模型保存路径
    segmentfilename = "./data/体育类/trainset_segment.txt"

    # modelfilename = "./model/体育类/word2vec(5).model"  # model = word2vec.Word2Vec(sentences, window=5, min_count=2)
    # modelfilename = "./model/体育类/word2vec(20).model"  # model = word2vec.Word2Vec(sentences, window=20, negative=2, min_count=2)
    modelfilename = "./model/体育类/word2vec(20.1).model"  # model = word2vec.Word2Vec(sentences, window=20, negative=2, min_count=2)
